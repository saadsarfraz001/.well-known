...
public class ExperienceAdapter extends RecyclerView.Adapter{
    ...
    public ExperienceAdapter(List<DemoItem> demoItems, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View row = inflater.inflate(R.layout.experience, parent, false);
        return new ExperienceAdapter.DemoItemHolder2(row);
    }
    @Override
